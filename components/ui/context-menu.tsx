...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ...
    collisionPadding={8}
    className={cn(
      "z-[10000] min-w-48 overflow-hidden rounded-xl border border-white/10 bg-[#0b1221] p-1 text-white shadow-[0_16px_40px_-18px_rgba(0,0,0,0.85)]",
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-white/45", inset && "pl-8", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Separator ref={ref} className={cn("my-1 h-px bg-white/10", className)} {...props} />
))
