...
import type { DeleteViewModalProps } from "@/types/dashboard-modals"
...
export function DeleteViewModal({
  ...
  if (!connection || !database || !viewName || !viewPath) {
    return null
  }
        ...
        <div className="max-h-[calc(100dvh-1rem)] overflow-y-auto">
          <div className="border-b border-white/10 px-5 py-4 pr-16">
            <DialogHeader className="text-left">
              <DialogTitle>Excluir view</DialogTitle>
              <DialogDescription>
                Essa ação não pode ser desfeita. A view {activeViewName} será removida da conexão{" "}
          ...
          <div className="space-y-5 p-5">
            <div className="rounded-2xl border border-amber-400/20 bg-amber-400/10 px-4 py-3 text-sm leading-6 text-amber-50">
              <div className="flex items-start gap-3">
                ...
                <p>
                  Ao confirmar, a view será excluída. Os dados originais das tabelas não serão
                  removidos.
                </p>
              </div>
            </div>
